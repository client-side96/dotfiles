...
(setq-default line-spacing 0.35) ;; Line spacing
...
;; Disable the lsp formatter for this languages:
;; NOTE: For JS/TS files I want to use prettier. As it is the default
